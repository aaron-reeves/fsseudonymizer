...
class CGlobals {
  public:
    ...
    static QString AppName() { return QStringLiteral( APP_NAME ); }
    ...
    static QString AppDescr() { return QStringLiteral( "Pseudonym generation plain-text and Microsoft Excel-formatted data sets" ); }
